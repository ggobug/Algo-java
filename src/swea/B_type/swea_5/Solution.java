...
public class Solution {
    ...
    public class Team {
        Node[] head = new Node[6];  // 각 점수의 첫 병사
        Node[] tail = new Node[6];  // 각 점수의 마지막 병사
    }

    public Team[] t = new Team[6];  // 점수별 팀 관리
    ...
    // 병사 고용
    void hire(int mID, int mTeam, int mScore) { // O(1)
    ...
    // 병사 해고
    void fire(int mID) {    // O(1)
        version[mID] = -1;
    }

    // 평판 점수 변경
    void updateSoldier(int mID, int mScore) {   // O(1)
